"""
账户应用 - 初始迁移
创建自定义 User 模型，包含 AbstractUser 全部字段及自定义字段（role, bio, avatar, phone）。
"""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', '学员'), ('teacher', '教师'), ('admin', '管理员')], default='student', max_length=20, verbose_name='角色')),
