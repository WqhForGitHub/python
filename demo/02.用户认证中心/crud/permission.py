...
def get_permissions_by_ids(db: Session, permission_ids: list[int]) -> list[models.Permission]:
    return (
...
def create_permission(db: Session, perm_in: schemas.PermissionCreate) -> models.Permission:
