...
注意：为避免与 employees.Department 的循环依赖，
本迁移不包含 User.department 字段。该字段由 0002_user_department.py 添加。
"""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                # ---- 自定义字段（不含 department）----
                ('employee_no', models.CharField(blank=True, help_text='员工唯一编号，可留空', max_length=30, unique=True, verbose_name='员工编号')),
                ('role', models.CharField(choices=[('staff', '普通员工'), ('manager', '部门经理'), ('admin', '管理员')], default='staff', max_length=20, verbose_name='角色')),
